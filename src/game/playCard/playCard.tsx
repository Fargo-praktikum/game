...
export const playCard = (context: CanvasRenderingContext2D, x: number, y: number, text?: string, keyNumber?: string):void => {
    const width = 160;
    const height = 190;
    const radius = 20;
    ...
    if(text){
        ...
        const textTest: string[] = getLines(context, text, width - 20);
...
function getLines(context: CanvasRenderingContext2D, text: string, maxWidth: number): string[] {
